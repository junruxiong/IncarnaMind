...
refine_qa_template = """Given the chat history and document names in the database, break down the follow-up input into fewer than 3 ONE-HOP queries for retrieval engine input, if it is a multi-hop or comparative query. The output must contain only queries and should maintain the same format as the original follow-up input.
